...
#define STRING_URL "beeverycreative.com"
...
#define CUSTOM_MENDEL_NAME "helloBEEprusa"
...
#define DEFAULT_MAX_FEEDRATE          {300, 300, 1, 25, 25}    // (mm/sec)
...
#define EXTRUDER_OFFSET_X {-33.5, 33.5} // (in mm) for each extruder, offset of the hotend on the X axis
